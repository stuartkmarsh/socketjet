...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UsageTransaction.user'
        db.delete_column('common_usagetransaction', 'user_id')


    def backwards(self, orm):
        
        # Adding field 'UsageTransaction.user'
        db.add_column('common_usagetransaction', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)
