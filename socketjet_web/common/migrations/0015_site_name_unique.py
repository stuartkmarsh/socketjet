...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'ApiAccount', fields ['site_prefix']
        db.create_unique('common_apiaccount', ['site_prefix'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'ApiAccount', fields ['site_prefix']
        db.delete_unique('common_apiaccount', ['site_prefix'])
    ...
    models = {
        ...
        'common.accountuserprofile': {
            ...
            'auth_token': ('django.db.models.fields.CharField', [], {'default': "'49853897fa294b6882cae2dfe8c0e9f3'", 'max_length': '100', 'blank': 'True'}),
