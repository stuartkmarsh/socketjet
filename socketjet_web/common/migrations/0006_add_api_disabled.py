...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApiAccount.disabled'
        db.add_column('common_apiaccount', 'disabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ApiAccount.disabled'
        db.delete_column('common_apiaccount', 'disabled')
