...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ApiAccount.nickname'
        raise RuntimeError("Cannot reverse this migration. 'ApiAccount.nickname' and its values cannot be restored.")
