...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApiAccount.secret_key'
        db.add_column('common_apiaccount', 'secret_key', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ApiAccount.secret_key'
        db.delete_column('common_apiaccount', 'secret_key')
