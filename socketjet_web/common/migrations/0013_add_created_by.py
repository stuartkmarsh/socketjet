...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserCreatedChannel.created_by'
        db.add_column('common_usercreatedchannel', 'created_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserCreatedChannel.created_by'
        db.delete_column('common_usercreatedchannel', 'created_by_id')
    ...
    models = {
        ...
        'common.accountuserprofile': {
            ...
            'auth_token': ('django.db.models.fields.CharField', [], {'default': "'010a305823e04156ac101b579a0fd722'", 'max_length': '100', 'blank': 'True'}),
