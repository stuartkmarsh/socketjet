...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ClientUserPermissions.is_admin'
        db.add_column('common_clientuserpermissions', 'is_admin', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ClientUserPermissions.is_admin'
        db.delete_column('common_clientuserpermissions', 'is_admin')
