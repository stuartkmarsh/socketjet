...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'UsageTransaction'
        db.create_table('common_usagetransaction', (
        ...
        db.send_create_signal('common', ['UsageTransaction'])


    def backwards(self, orm):
        
        # Deleting model 'UsageTransaction'
        db.delete_table('common_usagetransaction')
