...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'UserCreatedChannel', fields ['channel_name', 'site', 'created_by']
        db.create_unique('common_usercreatedchannel', ['channel_name', 'site_id', 'created_by_id'])

        # Deleting field 'ApiAccount.html_file'
        db.delete_column('common_apiaccount', 'html_file')

        # Deleting field 'ApiAccount.logo'
        db.delete_column('common_apiaccount', 'logo')

        # Deleting field 'ApiAccount.background_image'
        db.delete_column('common_apiaccount', 'background_image')


    def backwards(self, orm):
        
        # Removing unique constraint on 'UserCreatedChannel', fields ['channel_name', 'site', 'created_by']
        db.delete_unique('common_usercreatedchannel', ['channel_name', 'site_id', 'created_by_id'])
        ...
        # Adding field 'ApiAccount.html_file'
        db.add_column('common_apiaccount', 'html_file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'ApiAccount.logo'
        db.add_column('common_apiaccount', 'logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'ApiAccount.background_image'
        db.add_column('common_apiaccount', 'background_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'common.accountuserprofile': {
            ...
            'auth_token': ('django.db.models.fields.CharField', [], {'default': "'0ab556453e5948d58ccfa6e59ff3a0a4'", 'max_length': '100', 'blank': 'True'}),
        ...
        'common.usercreatedchannel': {
            'Meta': {'unique_together': "(('channel_name', 'created_by', 'site'),)", 'object_name': 'UserCreatedChannel'},
