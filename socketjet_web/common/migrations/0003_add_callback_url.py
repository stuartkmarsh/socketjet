...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApiAccount.callback_url'
        db.add_column('common_apiaccount', 'callback_url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ApiAccount.callback_url'
        db.delete_column('common_apiaccount', 'callback_url')
