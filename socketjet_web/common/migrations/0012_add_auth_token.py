...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AccountUserProfile.auth_token'
        db.add_column('common_accountuserprofile', 'auth_token', self.gf('django.db.models.fields.CharField')(default='7fd49d34f8ab4aebb767aa25e119cc22', max_length=100, blank=True), keep_default=False)

        # Adding field 'AccountUserProfile.is_verified'
        db.add_column('common_accountuserprofile', 'is_verified', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AccountUserProfile.auth_token'
        db.delete_column('common_accountuserprofile', 'auth_token')

        # Deleting field 'AccountUserProfile.is_verified'
        db.delete_column('common_accountuserprofile', 'is_verified')
    ...
    models = {
        ...
        'common.accountuserprofile': {
            ...
            'auth_token': ('django.db.models.fields.CharField', [], {'default': "'b8bd83aa347747c99b91f5249a901a5b'", 'max_length': '100', 'blank': 'True'}),
